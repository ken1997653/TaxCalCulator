...
namespace WindowsFormsApp9
{
	...
	public partial class Form1 : Form
	{
		...
		int[] comcartax = new int[] { 900,1260, 2160, 3060, 6480, 9900, 16380, 24300, 33660, 44460, 56700 };
		...
		private void Calculate_Click(object sender, EventArgs e)
		{
			...
			for (int c = 0; c < countyearsnum; c++)
			{
				...
				this.result.Text +=
					...
					$"應納稅額:{taxprice * daysinyears[c] / daynum[c]}元" + Environment.NewLine + Environment.NewLine + Environment.NewLine +
			...
			this.result.Text +=
			$"共計{countyearsnum}筆,應納稅總金額{totaltax}元" + Environment.NewLine + Environment.NewLine;
		}
